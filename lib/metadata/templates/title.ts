...
const TEMPLATE_MAP: Record<Route['pathname'], string> = {
  '/': 'VinuExplorer - The official block explorer for VinuChain',
  ...
  '/labels': '%network_name% label directory',
  ...
  '/name-services': '%network_name% VinuChain Name Service (VNS) - %network_name% explorer',
  '/name-services/domains/[name]': '%network_name% VNS: %name% domain details',
  '/name-services/clusters/[name]': '%network_name% VNS: %name% cluster details',
...
export function make(pathname: Route['pathname'], isEnriched = false) {
  ...
  const postfix = pathname !== '/' ? ' | VinuExplorer' : '';
