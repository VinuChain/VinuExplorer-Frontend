    ...
    ctViteConfig: {
      ...
      resolve: {
        alias: [
          ...
          // ...and for the widget itself, which otherwise talks to Google with
          // the fake site key and renders an init-error alert mid-capture.
          { find: 'ui/shared/reCaptcha/ReCaptcha', replacement: './playwright/mocks/ui/shared/recaptcha/ReCaptcha.js' },
