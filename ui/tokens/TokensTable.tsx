    ...
    <TableRoot minW="1120px" w="100%" tableLayout="fixed">
      <TableHeaderSticky top={ top ?? ACTION_BAR_HEIGHT_DESKTOP }>
        <TableRow>
          ...
          { /* Not sortable: /api/v2/tokens has no label sort, so this only ever
            * reordered the rows already on screen. On a paginated list that
            * reads as "sort by label" and delivers "sort this page by label". */ }
